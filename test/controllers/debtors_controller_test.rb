...
class DebtorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create debtor" do
    assert_difference('Debtor.count') do
      post debtors_url, params: { debtor: { contact: @debtor.contact, email: @debtor.email, name: @debtor.name } }
    end
  ...
  test "should update debtor" do
    patch debtor_url(@debtor), params: { debtor: { contact: @debtor.contact, email: @debtor.email, name: @debtor.name } }
